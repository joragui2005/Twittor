...
btnLocation.on('click', () => {
    ...
    if(navigator.geolocation){
        ...
        //Usa esta función con moderación, ya que resuelve más lentamente y consumirá más batería.
        var geoOptions = {
            enableHighAccuracy: true
        };


        navigator.geolocation.getCurrentPosition((pos, err, geoOptions) => {
            console.log(pos);
